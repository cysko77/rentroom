...
(function( $ ){
  $.fn.printPage = function(options) {
    ...
    var pluginOptions = {
      attr : "href",
      url : false,
      message: "Veuillez patienter pendant que nous créons votre document" 
    };
    ...
    var components = {
      ...
      messageBox: function(message){
        return "<div id='printMessageBox' style='\
          ...
          width:310px; height:150px; font-size:12px; padding:10px; color:#222; font-family:helvetica, arial;\
          opacity:0;\
