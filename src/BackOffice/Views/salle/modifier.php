...
<h1 class="pull-left"><span class="glyphicon glyphicon-star"></span>&nbsp;&nbsp;Modifier une salle</h1><br/>
...
<form action="" method="post" ENCTYPE="multipart/form-data">
    ...
    <div class="col-xs-6" style="padding-left:0">
        ...
        <div id="description" class="form-group <?php echo $error[0]; ?>" style="margin-bottom:6px">
            ...
            <textarea name="description" class="form-control" rows="8" placeholder="Description" id="textareaDescription"><?php echo $data->valeur($dataReponse, "description"); ?></textarea>
        </div>
    ...
    <div class="col-xs-6 " style="padding-right:0;">
        ...
        <div id="divInputImg" class="form-group <?php echo $error[0]; ?>">
            ...
            <div class="col-xs-12 form-control" style="height:165px; margin-bottom: 15px">
                <div id="divPhoto" class="col-xs-6"><img id="uploadImg" src="lokisalle/images/salles/miniature/<?php echo $data->valeur($dataReponse, "photo"); ?>" alt="<?php echo $data->valeur($dataReponse, "photo"); ?>"></div>
        ...
        <div id="adresse" class="form-group <?php echo $error[0]; ?> marginTop" style="margin-bottom:6px">
            ...
            <textarea name="adresse" class="form-control" rows="2" placeholder="Adresse" id="textareaAdresse"><?php echo $data->valeur($dataReponse, "adresse"); ?></textarea>
        </div>
