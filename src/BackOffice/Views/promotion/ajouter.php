...
<h1 class="pull-left"><span class="glyphicon glyphicon-star"></span>&nbsp;&nbsp;Ajouter une promotion</h1><br/>
<div class="col-xs-2 pad0 pull-right" style="margin-top:5px">
    <div class="btn-group btn-group-justified">
        ...
        <div class="btn-group">
            <a href="index.php?controller=promotion&action=ajouter"  class="btn btn-warning">Ajouter</a>
        </div>
    </div>
</div>
<br class="clear"/>
