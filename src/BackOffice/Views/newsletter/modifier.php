...
<h1 class="pull-left"><span class="glyphicon glyphicon-star"></span>&nbsp;&nbsp;Modifier une newsletter</h1><br/>
...
<form class="marginTop30" action="" method="post">
   ...
   <div class="col-xs-12" style="padding:0">
    ...
    <div class="form-group pull-left" style="margin-top:25px">
        <button type="submit" class="btn btn-warning">Modifier la newsletter</button>
    </div>
    <br class="clearfix"/>
</form>
<br/>
